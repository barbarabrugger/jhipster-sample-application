...
import ch.qfs.sample.service.CategoryService;
...
class CategoryResourceIT {
     ...
     *
     * @see ch.qfs.sample.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchCategory() throws Exception {
        ...
        // Initialize the database
        categoryRepository.saveAndFlush(category);
        when(mockCategorySearchRepository.search("id:" + category.getId(), PageRequest.of(0, 20)))

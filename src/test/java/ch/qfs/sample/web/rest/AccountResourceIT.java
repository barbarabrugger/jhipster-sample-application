...
import static ch.qfs.sample.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static ch.qfs.sample.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static ch.qfs.sample.test.util.OAuth2TestUtil.testAuthenticationToken;

...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('jhipsterSampleApplicationApp.product.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/jhipsterSampleApplicationApp.product.delete.question/);

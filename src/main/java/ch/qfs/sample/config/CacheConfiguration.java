...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ch.qfs.sample.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ch.qfs.sample.repository.UserRepository.USERS_BY_EMAIL_CACHE);

        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.address.address1')}
                id="address-address1"
                name="address1"
                data-cy="address1"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.address.address2')}
                id="address-address2"
                name="address2"
                data-cy="address2"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.address.city')}
                id="address-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.address.postcode')}
                id="address-postcode"
                name="postcode"
                data-cy="postcode"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.address.country')}
                id="address-country"
                name="country"
                data-cy="country"
                type="text"
              ...
              <ValidatedField
                ...
                name="customer"
                data-cy="customer"
                label={translate('jhipsterSampleApplicationApp.address.customer')}
                type="select"
              >
                <option value="" key="0" />
                {customers

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.category.sortOrder')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.category.dateAdded')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.category.dateModified')}
              ...
              />
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.category.status')}
                id="category-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {categoryStatusValues.map(categoryStatus => (
                  <option value={categoryStatus} key={categoryStatus}>
                    {translate('jhipsterSampleApplicationApp.CategoryStatus.' + categoryStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('jhipsterSampleApplicationApp.category.parent')}
                type="select"
              >
                <option value="" key="0" />
                {categories
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.category.product')}
                id="category-product"
                data-cy="product"
                type="select"
                multiple

...
export const WishListDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.wishList.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.wishList.delete.question" interpolate={{ id: wishListEntity.id }}>

...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.customer.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
